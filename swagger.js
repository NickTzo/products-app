  ...
  "paths": {
    "/api/users": {
              ...
              "application/json": {
                "schema": {
                  ...
                  "items": {
                    ...
                    // to apo panw pigene diavase to ipopedio schemas kai pare to pedio users einai gia thn swagger
                  }
                }
              }
            }
      ...
      "post": {
        ...
        "requestBody": {
          ...
          "content": {
            // "application/x-www-form-urlencoded": {  //Δειχνει διαφορετικα στην swagger τα πεδια που βαζουμε παραμετρους
            "application/json": {
              "schema": {
                "type": "object",
                "properties": {
        ...
        "parameters": [
          {
            ...
            "in": "path",
            "required": true,
            "description": "Username of user that we wnat to find",
            "type": "string"
          }
        ],
    ...
    "/api/products": {
      ...
      "post": {
        ...
        "responses": {
          "400": {
            "description": "Problem in creating product"
          }
        }
      },
      "patch": {
    ...
    "/api/products/{products}": {
      "get": {
        ...
        "description": "Get one product if exists",
        "parameters": [
          {
            "name": "product",
            "in": "path",
